...
const images: GalleryImage[] = [
  ...
  { id: 4, url: 'https://images.unsplash.com/photo-1544148103-0773bf10d330?auto=format&fit=crop&w=800&q=80', alt: 'Restaurant Vibe' }, // Replaced duplicate/unoptimized image if needed
...
export const GallerySection: React.FC = () => {
  return (
    <section className="py-24 bg-stone-900 min-h-screen">
